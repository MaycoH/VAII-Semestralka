        ...
        <form method="POST" enctype="multipart/form-data" action="?c=home&a=editActualityPostBack&postid=<?=$data['postid']?>"> <!-- controller = "Home", akcia = "upload" enctype="multipart/form-data"-->
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input name="titulok" type="text" id="nazovClanku" class="form-control" placeholder="<?= $data['titulok'] ?>" content="yyyy">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="textClanku" id="textClanku" class="form-control" rows="15" placeholder="<?= $data['textClanku'] ?>"></textarea>
                </div>
...
<!--                <form method="GET" enctype="multipart/form-data" action="?c=home&a=redirectToHome">-->
